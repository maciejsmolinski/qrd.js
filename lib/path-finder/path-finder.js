;(function() {
  ...
  PathFinder.prototype.setStartPoint = function () {

  };

  PathFinder.prototype.setEndPoint = function () {
  ...
  PathFinder.prototype.__findPoint = function (option) {
    if (option === 'first') { return this.points[0]; }
      ...
      throw new Error('PathFinder::__findPoint(option) Unknown type of option provided');
    }
  };
